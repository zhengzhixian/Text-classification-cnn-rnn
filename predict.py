...
class CnnModel:
    ...
    def predict(self, message):
        ...
        y_prob_cls = self.session.run(self.model.y_pred_prob, feed_dict=feed_dict)[0]
        y_categories = self.categories[y_pred_cls[0]]
        return y_prob_cls, y_categories


if __name__ == '__main__':
    cnn_model = CnnModel()
    test_demo = ['没有太多的要求，要互相包容互相信任真心对待就好了']
